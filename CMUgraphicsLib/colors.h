...
const color GRAY = color(170, 170, 170);
const color GREY = color(170, 170, 170);
...
const color DARK_TURQUOISE = color(0, 150, 150);
...
const color DARK_YELLOW = color(215, 180, 0);
...
const color BROWN = color(130, 65, 0);
const color DARK_BROWN = color(65, 30, 0);
const color DARKSALMON = color(233, 150, 122);
const color SALMON = color(250, 128, 114);
const color LIGHTSALMON = color(255, 160, 122);
const color ORANGE = color(255, 100, 0);
const color DARK_ORANGE = color(205, 50, 0);
...
const color PINK = color(255, 0, 110);
const color DARK_PINK = color(125, 0, 55);
...
const color VIOLET = color(180, 0, 255);
...
const color DARK_VIOLET = color(90, 0, 130);
...
const color DARK_GREY = color(85, 85, 85);
const color DARK_GRAY = color(85, 85, 85);
